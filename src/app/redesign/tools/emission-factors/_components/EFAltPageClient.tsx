    ...
    <>
      ...
      <section className="relative">
        {supersedingSlug && (
          <div className="mx-auto max-w-6xl px-6 pt-6">
            <Link
              href={`/redesign/tools/emission-factors/${supersedingSlug}/alt`}
          ...
          <div>
            ...
            <dl className="divide-y divide-white/5 font-mono text-[13px]">
              ...
              <Row
                ...
                value={
                  <Link
                    href={`/redesign/tools/emission-factors/sources/${factor.source.id}`}
        ...
        <section className="border-t border-white/5">
          <div className="mx-auto max-w-6xl px-6 py-12">
            <div className="flex items-center justify-between">
              ...
              <Link
                href="/redesign/tools/emission-factors/search"
            ...
            <ul className="mt-6 divide-y divide-white/5" role="list">
              {related.map((r) => (
                <li key={r.id}>
                  <Link
                    href={`/redesign/tools/emission-factors/${r.slug}/alt`}
      ...
      <section className="border-t border-white/5">
        <div className="mx-auto max-w-6xl px-6 py-10 flex flex-wrap items-center justify-between gap-4 font-mono text-[11px] text-white/40">
          ...
          <Link
            href="/redesign/tools/emission-factors"
