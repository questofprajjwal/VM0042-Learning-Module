---
title: "CBAM 2026: Start Date, Surrender Deadline, and the First Payment Timeline"
...
Here is the cleaner way to see it. The EU has been putting a [carbon price](/courses/carbon-pricing) on its own industries for twenty years through the EU Emissions Trading System. That means a steel mill in Germany pays for every tonne of CO2 it emits. A steel mill in Turkey does not. For a long time, the EU covered this gap by giving its own producers free allowances, so they would not lose business to cheaper imports.
