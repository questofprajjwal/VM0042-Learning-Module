...
This four-pillar structure was adopted wholesale by IFRS S2.
...
<table class="mb-6">
  ...
  <tr><td>Governance pillar</td><td>Paragraphs 5-7</td><td>More specific disclosure requirements for board and management roles</td></tr>
  <tr><td>Strategy pillar</td><td>Paragraphs 8-23</td><td>Explicit requirements for financial effects and transition plans</td></tr>
  <tr><td>Risk Management pillar</td><td>Paragraphs 24-26</td><td>Requires disclosure of opportunity management processes too</td></tr>
  <tr><td>Metrics &amp; Targets pillar</td><td>Paragraphs 27-37</td><td>Mandatory GHG Protocol basis, seven cross-industry categories, financed emissions</td></tr>
  <tr><td>Scenario analysis guidance</td><td>Appendix B, B1-B18</td><td>Commensurate with circumstances; linked to resilience assessment</td></tr>
</table>
</ResponsiveTable>
...
<HighlightBox>
**Key takeaway:** IFRS S2's four-pillar structure (governance, strategy, risk management, metrics and targets) is directly inherited from the TCFD. The ISSB converted the TCFD's voluntary framework into a mandatory global standard with specific disclosure rules, GHG measurement requirements, and financial impact analysis obligations. Understanding TCFD is the best foundation for understanding IFRS S2.
</HighlightBox>
