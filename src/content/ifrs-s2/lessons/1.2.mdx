...
**(i) Whether the role has been delegated to a specific management-level position, committee, or individual**, and if so, details of that role:
- The specific management-level position or committee with day-to-day responsibility
- How that role relates to the governance body (e.g., reporting lines)
...
- What controls exist over climate data collection (e.g., GHG emissions measurement)
...
- **Treasury/Finance** — Is climate risk factored into financing decisions, debt covenants, or insurance arrangements?
- **Legal/Compliance** — Are regulatory developments (carbon pricing, physical disclosure requirements) monitored and integrated into risk management?
...
<HighlightBox>
**Key takeaway:** Management-level governance disclosures answer two questions: who has day-to-day responsibility for climate risk management (role identification), and is that management supported by robust processes (controls and procedures). Together with board-level disclosures, they show investors whether climate governance is embedded in the entity's operational fabric or limited to boardroom conversations.
</HighlightBox>
