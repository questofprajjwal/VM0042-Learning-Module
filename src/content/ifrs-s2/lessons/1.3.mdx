...
This principle was reinforced in the Basis for Conclusions (BC31-BC32): the ISSB closely aligned IFRS S2 governance requirements with IFRS S1's general requirements to ensure consistency and avoid duplication across sustainability topics.

## How Governance Connects to Strategy

Governance disclosures should make clear that the identified governance bodies are actually engaged with the strategic decisions described in the Strategy pillar. Signs of meaningful connectivity:

- The governance body is involved in approving or reviewing the transition plan (Para 14)
- The governance body oversees climate-related target-setting (Para 6(a)(v)) and those targets appear in the Metrics and Targets section (Para 33-37)
...
The explicit connection in Para 6(a)(v) — the governance body oversees target-setting and monitors progress — means investors can check whether the governance body's remuneration linkages are aligned with the targets disclosed in Para 33-37.
...
<table class="mb-6">
  ...
  <tr><td>Executive remuneration linked to emissions target</td><td>Metrics — Para 29(g): remuneration metric; Para 33-36: target details</td></tr>
...
<ExampleBox>
**Example of disconnected governance (common quality issue):**
