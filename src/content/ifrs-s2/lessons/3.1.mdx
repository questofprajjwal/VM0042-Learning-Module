...
**(b) Risks with significant potential for material adjustment** — Any climate-related risk that could reasonably be expected to result in a material adjustment to the carrying amount of an asset or liability within the *next* annual reporting period must be disclosed. This mirrors the requirements for significant estimation uncertainty in financial reporting.
...
## Quantitative or Qualitative? (Para 17-18)
...
## Exemptions from Quantitative Disclosure (Para 19-20)
...
The entity lacks the skills, capabilities, or resources to produce quantitative estimates at the current time.

Para 20 is a temporary relief that acknowledges many entities are building their climate financial modelling capabilities. It is not a permanent exemption.
...
*Current effects:* "In 2024, storm damage to two properties resulted in asset impairments of £12 million. Insurance recoveries of £8 million were recognised. Net P&L impact: £4 million."

*Anticipated effects (medium term):* "Based on IPCC RCP 4.5 projections for our operating geography, we estimate 15–25% of our portfolio by book value (£180–300 million) faces a moderate-to-high probability of recurring flood damage within 10 years. We disclose a range rather than a point estimate given uncertainty in local sea level projections. This represents the key climate-related risk with potential for material adjustment to asset carrying values."
...
<HighlightBox>
**Key takeaway:** Financial effects disclosures connect climate risks to specific financial statement impacts — assets, liabilities, revenues, costs, and cash flows. IFRS S2 requires both current effects (what has already happened) and anticipated effects (what is expected). Quantitative disclosure is preferred, but two exemptions allow qualitative alternatives where quantification is not feasible or useful. Even when exemptions are used, specific financial statement line items must be identified.
</HighlightBox>
