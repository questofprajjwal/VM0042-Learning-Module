...
- **Long time horizons** — anticipated effects over 20–30 years involve compounding uncertainty about future climate conditions, technologies, policies, and markets
...
The ISSB recognised these constraints in the Basis for Conclusions (BC53-BC56) and created two specific exemptions while maintaining an expectation that capabilities will improve.
...
**21(c) Combined quantitative information** — Unless this too is not useful, the entity should still provide the combined financial effects — a single figure or range representing the aggregate impact of all climate risks on the financial statements. Even if individual attribution is too uncertain, a combined impact estimate may be possible.
...
2. **Year 2-3:** Partial quantification — perhaps some scenarios or some risks quantified
...
Our current best estimate of combined anticipated financial impact from physical risks over the medium term is a range of £20–60 million in additional capital expenditure requirements, based on preliminary analysis of our coastal and riverside site exposure."
</ExampleBox>

<HighlightBox>
**Key takeaway:** IFRS S2 provides two exemptions from quantitative financial effects disclosure — when effects are not separately identifiable or measurement uncertainty is too high (Para 19), or when the entity lacks the capability (Para 20). But these exemptions are not free passes: entities must explain why they cannot quantify, identify which financial statement line items are affected, and provide combined quantitative information where possible. The exemptions are transitional — the expectation is that capabilities improve over time.
</HighlightBox>
