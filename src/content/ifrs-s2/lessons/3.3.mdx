...
IFRS S2 makes a crucial distinction (elaborated in Application Guidance B1-B3):
...
This distinction has a practical implication: scenario analysis does not need to be redone every year. It can be aligned with the entity's strategic planning cycle (e.g., every 3-5 years — see B18). But the resilience assessment itself must be updated and disclosed in every annual report, even in years when scenario analysis is not re-run.

## Assessing the Circumstances (B2-B7)

Application Guidance B2-B7 describes how to calibrate the sophistication of scenario analysis to the entity's circumstances.

**B4-B5 — Exposure level:** Entities with higher exposure to climate risks should conduct more sophisticated scenario analysis. An entity with significant physical assets in climate-vulnerable locations, or with a business model highly sensitive to carbon pricing, faces higher exposure and should invest more in analytical rigour.

**B6-B7 — Skills, capabilities, and resources:** The approach must also be commensurate with what the entity can reasonably do. An entity early in its climate risk journey may begin with qualitative narratives based on publicly available scenarios. This is acceptable. The ISSB explicitly acknowledges that scenario analysis is an evolving practice — the expectation is iterative improvement.

<ResponsiveTable>
<table class="mb-6">
  <tr><th>Exposure Level</th><th>Capability Level</th><th>Expected Approach</th></tr>
  <tr><td>High exposure (e.g., oil &amp; gas, coastal infrastructure)</td><td>Advanced modelling capability</td><td>Quantitative scenario modelling with financial impact ranges</td></tr>
  ...
  <tr><td>Moderate exposure (e.g., manufacturing, retail)</td><td>Developing capability</td><td>Mix of qualitative narrative and quantitative modelling for key risks</td></tr>
  <tr><td>Lower exposure (e.g., software, services)</td><td>Any level</td><td>Qualitative resilience narrative; focus on transition risks and opportunities</td></tr>
</table>
</ResponsiveTable>

<HighlightBox>
**Key takeaway:** Climate resilience disclosure under IFRS S2 has two parts: the resilience assessment (what the analysis reveals) and the methodology (how it was done). Resilience assessments must be updated annually; the underlying scenario analysis can follow the strategic planning cycle. The sophistication of scenario analysis is commensurate with the entity's exposure and capabilities — qualitative narratives are acceptable for lower-exposure or earlier-stage entities, with the expectation of iterative improvement.
</HighlightBox>
