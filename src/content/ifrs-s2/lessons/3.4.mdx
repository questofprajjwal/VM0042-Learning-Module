...
Application Guidance B8 establishes the foundation: entities must use **all reasonable and supportable information** available without undue cost or effort. This is the same standard applied throughout IFRS S2.
