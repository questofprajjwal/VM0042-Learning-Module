...
## Practical Examples of Assessment Approaches
...
*Likelihood:* Scored 1–5 based on estimated probability of occurrence within our planning horizon. For transition risks, we use regulatory calendars and IEA policy scenario probabilities. For physical risks, we use IPCC regional hazard projections.

*Financial impact:* Scored 1–5 based on estimated impact on EBITDA, ranging from less than 1% (score 1) to greater than 10% (score 5).

*Strategic impact:* Scored 1–5 based on impact on competitive position, market share, and operational continuity.
