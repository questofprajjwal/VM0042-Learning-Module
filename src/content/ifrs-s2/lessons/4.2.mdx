...
IFRS S2 is unusual among risk frameworks in explicitly requiring disclosure of processes for identifying and managing **climate-related opportunities** — not just risks. Paragraph 25(b) requires the entity to describe:
...
- How opportunities are integrated into the entity's overall business planning
...
Paragraph 26 applies the same efficiency principle as paragraph 7 (governance): if climate risks are managed on an integrated basis with other sustainability risks (e.g., water risk, biodiversity risk), the entity need not provide separate risk management disclosures for each topic. An integrated description — clearly indicating which elements apply to climate — is sufficient.
...
- **Strategy:** The significant risks identified in risk management should correspond to the risks disclosed in the strategy section (Para 10-12)
...
<HighlightBox>
**Key takeaway:** IFRS S2 risk management disclosures cover both risks and opportunities, with parallel requirements for each. Integration with the enterprise risk management framework is a key quality indicator — fully integrated climate risk management is more credible than siloed sustainability processes. Paragraph 26 allows integrated disclosures across sustainability topics to avoid duplication. The risk management section must be consistent with what governance, strategy, and metrics disclosures describe.
</HighlightBox>
