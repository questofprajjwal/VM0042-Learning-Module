...
The ISSB's design intent, articulated in the Basis for Conclusions (BC70-BC72), was that the four pillars of IFRS S2 should form a coherent, interconnected disclosure framework — not a series of independent checklists. Each pillar generates information that feeds into and is informed by the others.
...
<table class="mb-6">
  ...
  <tr><td>Metrics &amp; Targets</td><td>Performance data; target progress</td><td>Governance (progress reporting to board), Risk Management (monitoring of risk KPIs)</td></tr>
</table>
</ResponsiveTable>
...
- **Strategy — Financial Effects (Para 15-21):** Scenario analysis informs the anticipated *financial impacts* of climate risks
...
## The Risk Management-Strategy Connection
...
The ISSB balanced two competing concerns in designing the risk management requirements (BC71-BC72):
...
<HighlightBox>
**Key takeaway:** The four IFRS S2 pillars form a closed, mutually reinforcing loop. Risk management provides the analytical foundation for strategy. Governance provides the accountability structure for metrics. Scenario analysis connects risk management, strategy, and governance. The ISSB explicitly designed this interconnection, and investors will scrutinise inconsistencies between pillars as signals of disclosure quality or strategic credibility problems.
</HighlightBox>
