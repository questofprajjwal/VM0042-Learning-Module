...
Paragraph 29(a) of IFRS S2 requires entities to disclose **absolute gross greenhouse gas emissions** in metric tonnes of CO₂ equivalent (tCO₂e), disaggregated into:
...
<table class="mb-6">
  ...
  <tr><td>Carbon dioxide</td><td>CO₂</td><td>Fossil fuel combustion, deforestation</td><td>1</td></tr>
  <tr><td>Methane</td><td>CH₄</td><td>Agriculture, natural gas systems, waste</td><td>29.8</td></tr>
  <tr><td>Nitrous oxide</td><td>N₂O</td><td>Agriculture, fossil fuel combustion</td><td>273</td></tr>
  ...
  <tr><td>Sulphur hexafluoride</td><td>SF₆</td><td>Electrical equipment, magnesium smelting</td><td>25,200</td></tr>
  <tr><td>Nitrogen trifluoride</td><td>NF₃</td><td>Electronics manufacturing</td><td>17,400</td></tr>
</table>
</ResponsiveTable>

## Converting to CO₂ Equivalent (B20-B22)

All seven gases must be aggregated into a single metric — **CO₂ equivalent (CO₂e)** — using their **100-year global warming potential (GWP)** values.

<FormulaBox>
CO₂e = Quantity of gas (tonnes) × Global Warming Potential (GWP)

Example: 10 tonnes of CH₄ × 29.8 (GWP₁₀₀, IPCC AR6) = 298 tCO₂e
</FormulaBox>
...
## The GHG Protocol — The Mandatory Basis (B23-B25)
...
- Fugitive emissions (e.g., methane leaks from gas infrastructure)
- Process emissions (e.g., CO₂ from cement production, N₂O from chemical manufacturing)
- Agricultural emissions

## Scope 2 — Purchased Energy (B30-B31)
...
<HighlightBox>
**Key takeaway:** Every entity must disclose absolute gross Scope 1, 2, and 3 emissions in tCO₂e using the GHG Protocol as the mandatory basis. Scope 1 covers direct emissions from owned/controlled sources; Scope 2 covers purchased electricity and heat, disclosed on a location-based basis with information about contractual instruments. Entities must choose and disclose an equity share or control consolidation approach, and disaggregate Scope 1 and 2 between the consolidated accounting group and other investees.
</HighlightBox>
