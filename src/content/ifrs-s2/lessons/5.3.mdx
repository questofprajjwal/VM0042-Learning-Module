...
The GHG Protocol Scope 3 Standard acknowledges this inherent uncertainty. IFRS S2 Application Guidance B38-B57 builds on the GHG Protocol to provide a measurement framework that ensures Scope 3 estimates are as reliable as possible within practical constraints.

## The Measurement Framework Overview (B38-B42)
...
**B41-B42:** The framework applies regardless of which specific measurement method is used. Judgement is required to navigate trade-offs between data quality characteristics.
...
<table class="mb-6">
  ...
  <tr><td>Direct measurement data</td><td>B43-B45</td><td>Actual measured emissions, not estimated</td></tr>
  <tr><td>Specific value chain activity data</td><td>B46-B49</td><td>Data from specific suppliers/customers rather than industry averages</td></tr>
  <tr><td>Timely, representative data</td><td>B50-B52</td><td>Data current, from the right jurisdiction and technology</td></tr>
  <tr><td>Verified data</td><td>B53-B54</td><td>Data that has been independently verified</td></tr>
</table>
</ResponsiveTable>

## Direct Measurement Data (B43-B45)
...
When direct measurement is not available, entities use **activity data × emission factors**:

<FormulaBox>
Scope 3 Emissions = Activity Data × Emission Factor

Example:
Category 1 (purchased materials):
10,000 tonnes of steel purchased × 1.85 tCO₂e/tonne steel (emission factor) = 18,500 tCO₂e
</FormulaBox>

Activity data might be the quantity of materials purchased, distance travelled, or weight of waste disposed. Emission factors convert that activity into CO₂e.

## Primary vs Secondary Activity Data (B46-B49)

When activity data is used, it can come from two sources:

**Primary data** — data collected directly from specific suppliers, customers, or operations in the entity's value chain. Examples:
...
**Secondary data** — industry averages, published databases, or other non-specific estimates. Examples:
- Industry-average emission intensity for steel (tonnes CO₂e per tonne steel)
- Life cycle assessment (LCA) databases
- Economic input-output models

B46-B49 establish that **primary data is preferred** over secondary data because it reflects the actual characteristics of the specific supplier or customer. However, secondary data is acceptable — and often the only feasible option — especially for indirect, multi-tier supply chain emissions.

## Timely, Representative Data (B50-B52)
...
- **Jurisdiction-representative** — emission factors specific to the country or region, not global averages (e.g., the carbon intensity of the Chinese electricity grid is much higher than the French grid)
...
## Disclosure of the Measurement Approach (B55-B56)

B55-B56 require entities to disclose:
...
For Category 11 (use of sold products — refrigeration energy use), we use product technical specifications and average usage patterns from consumer research to estimate product lifetime energy consumption, converted to CO₂e using location-based electricity grid emission factors by sales territory."
</ExampleBox>

<HighlightBox>
**Key takeaway:** IFRS S2's Scope 3 measurement framework provides structured guidance for navigating data quality trade-offs. The four characteristics to prioritise are: direct measurement data, specific value chain data (primary over secondary), timely and representative data, and verified data. Entities must disclose their measurement approach and how they have navigated these trade-offs. The impracticability backstop applies only in genuinely impossible situations — not as a convenience.
</HighlightBox>
