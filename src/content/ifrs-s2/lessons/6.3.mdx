...
IFRS S2 was effective from 1 January 2024. Almost immediately, the Transition Implementation Group (TIG) and preparers identified areas where the standard's requirements created unintended complexity or conflicts. The ISSB received 179 comment letters on the April 2025 Exposure Draft of amendments and concluded that the identified issues were genuine implementation challenges not anticipated during the standard's development.
...
## Amendment 1 — Scope 3 Category 15 (Paragraphs 29A-29C)
...
- Enables classification of investees/counterparties in a way that provides useful information about climate-related transition risk exposure
- Prioritises commonly used systems (e.g., GICS, or a system required by the entity's jurisdiction)
...
## Amendment 4 — GWP Values Jurisdictional Relief (B21-B22)

**The problem:** IFRS S2 requires use of GWP values from the latest IPCC assessment (AR6). Some jurisdictions require entities to use older GWP values (e.g., AR5 values), creating a need to produce two sets of calculations — one for jurisdictional compliance, one for IFRS S2.
...
<table class="mb-6">
  ...
  <tr><td>Category 15 limitation (29A-29C)</td><td>Undefined scope of "investments" in Scope 3</td><td>1 Jan 2027 (early application permitted)</td></tr>
  ...
  <tr><td>GWP values jurisdictional relief (B21-B22)</td><td>Dual calculation burden where jurisdiction requires older GWP values</td><td>1 Jan 2027 (early application permitted)</td></tr>
</table>
</ResponsiveTable>

<HighlightBox>
**Key takeaway:** The December 2025 amendments to IFRS S2 address four practical implementation challenges: Category 15 scope ambiguity, GICS licensing requirements, partial-entity GHG Protocol conflicts, and GWP value jurisdiction conflicts. All four are effective from 1 January 2027 with early application permitted. The amendments reduce complexity without reducing the core investor-relevant information required — particularly the clear presentation framework for financed emissions introduced by paragraphs 29A-29C.
</HighlightBox>
