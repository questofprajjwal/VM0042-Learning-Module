...
**Purpose:** Shows investors the scale of financial exposure to transition risks — how much of the entity's balance sheet could be affected by carbon pricing, regulatory changes, or shifting market preferences.
...
**Purpose:** Balances the risk picture with the opportunity side — how much of the entity's business is positioned to benefit from the transition.
...
<AnalogyBox>
Categories (b)-(e) work together like a corporate risk and opportunity balance sheet: 29(b) and (c) show the "liabilities" side — how much of the business is exposed to transition and physical risks. 29(d) and (e) show the "asset" side — how much of the business is positioned to benefit, and how much capital is being invested to capture those opportunities.
</AnalogyBox>
...
- **Internal fee/tax** — an actual charge levied on business units for their emissions, creating a fund for climate investments
...
B65 provides guidance on preparing (b)-(g) disclosures: consider time horizons, where in the value chain concentrations exist, financial effects, relevant industry-based metrics, and connections to the financial statements.
...
<table class="mb-6">
  ...
  <tr><td>(f) Internal carbon price</td><td>Currency per tCO₂e</td><td>Price used; type (shadow vs fee); whether used</td></tr>
  <tr><td>(g) Remuneration</td><td>Percentage</td><td>% of executive pay linked to climate metrics</td></tr>
</table>
</ResponsiveTable>

<HighlightBox>
**Key takeaway:** The six non-GHG cross-industry metric categories create a comprehensive quantitative picture of climate exposure and commitment: (b) and (c) measure how much of the business is at risk from transition and physical factors; (d) and (e) measure climate-aligned opportunity and capital investment; (f) and (g) measure whether climate is embedded in business decisions and executive incentives. Together with GHG emissions (a), they give investors the data to assess whether an entity's climate narrative is backed by financial reality.
</HighlightBox>
