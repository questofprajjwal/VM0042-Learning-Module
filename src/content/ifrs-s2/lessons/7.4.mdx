...
**Shadow price (notional)** — a hypothetical price applied in financial modelling and investment appraisal. If a new project is evaluated with an internal carbon price of $50/tonne, projects with high emissions become less attractive compared to low-emission alternatives, even before any external carbon tax or cap-and-trade system is in force.
...
The Basis for Conclusions (BC130) notes that internal carbon pricing is one of the most effective tools for embedding long-term climate risk into near-term business decisions. An entity with an internal carbon price of $100/tCO₂e is de facto preparing for a carbon-constrained future — it is selecting lower-carbon investments today because they become more economically attractive when carbon costs are internalised.

<ExampleBox>
**Example:** A global chemicals company discloses:

"We apply an internal shadow carbon price of USD 80 per tonne CO₂e (2024), rising to USD 150/tonne by 2030. This price is applied to all capital investments above USD 5 million. In 2024, 14 projects passed an initial financial screen but were rejected or redesigned following the internal carbon price assessment, avoiding an estimated 280,000 tCO₂e of annual emissions over a 15-year asset life. The carbon price is reviewed annually by the Chief Financial Officer and updated to reflect emerging regulatory carbon price trajectories."
</ExampleBox>

<AnalogyBox>
An internal carbon price is like a company that prices externalities into its own decisions before regulators require it. It's the corporate equivalent of a household buying a fuel-efficient car not because fuel taxes force it, but because the household "charges itself" the true long-run cost of fuel. Companies with internal carbon prices are building transition risk resilience into their capital allocation — voluntarily, before external constraints force the adjustment.
</AnalogyBox>
...
Remuneration linkage is a governance signal of the highest order. Executive pay structures reveal what an organisation truly values. An entity that:
- Has a net-zero commitment but no remuneration linkage to emissions targets — management has no personal financial stake in delivery
- Has 25% of long-term incentive awards linked to an emissions reduction target — management's wealth depends on climate performance
...
<table class="mb-6">
  ...
  <tr><td>Short-term incentive KPI</td><td>Annual bonus partially tied to a climate metric (e.g., 5-10%)</td><td>Moderate — annual focus, may encourage short-termism</td></tr>
  <tr><td>Long-term incentive condition</td><td>Vesting of multi-year share awards conditional on climate target (e.g., 20-30%)</td><td>Strong — multi-year horizon, material financial stake</td></tr>
</table>
</ResponsiveTable>

<HighlightBox>
**Key takeaway:** Internal carbon pricing (Para 29(f)) and executive remuneration linkage (Para 29(g)) are the two cross-industry metrics that most directly test whether climate is embedded in decision-making and accountability structures. An entity with a high internal carbon price ($100+/tonne) applied to all capital decisions, and with 20-30% of executive pay linked to emissions targets, is structurally positioned for transition. An entity with no carbon price and no remuneration linkage faces questions about the credibility of any climate commitments it has made.
</HighlightBox>
