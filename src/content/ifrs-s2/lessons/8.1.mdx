...
The December 2025 amendments to GHG Emissions Disclosures (paragraphs 29A-29C and related changes) are effective for **annual reporting periods beginning on or after 1 January 2027** (paragraph C1B), with earlier application permitted.

## First-Year Transition Reliefs (C3-C5)
...
The Basis for Conclusions (BC165-BC167) notes that this relief is consistent with standard IFRS first-adoption practice and acknowledges that many entities will not have prior-year climate data in the required format.
...
This accommodates entities that had already invested in alternative climate reporting systems (e.g., a company that was using a national standard or industry-specific methodology). Over time, the expectation is that all entities will migrate to the GHG Protocol basis.
...
This is the most significant transition relief and was one of the most discussed in the development of the standard (BC168-BC177). The rationale:
...
- (b) Category 15 total and financed emissions subtotal presentation
- (c) Industry classification system changes for financed emissions disaggregation

If adjusting comparative information is impracticable, the entity should disclose that fact.

## The Qualified Compliance Statement Prohibition

As noted in Lesson 0.4, entities cannot make a qualified compliance statement — they cannot say "we comply with IFRS S2 except for [X]." The transition reliefs provide the escape valves for genuine first-year constraints. Outside of those reliefs, IFRS S2 compliance requires meeting all requirements (BC157-BC164).
...
<HighlightBox>
**Key takeaway:** IFRS S2 was effective from 1 January 2024. Three first-year transition reliefs address practical implementation constraints: no comparative information requirement, permission to continue using non-GHG Protocol methods, and deferral of Scope 3 disclosures. All three apply only in year 1 — full compliance is expected from year 2 onwards. The 2025 amendments have their own effective date (1 January 2027) and transitional provisions, including comparative period adjustments.
</HighlightBox>
